INSERT INTO redculture.spots (name,location,history) VALUES
...
INSERT INTO redculture.spots (name,location,history) VALUES
	 ('圆明园遗址公园','北京市海淀区','圆明园遗址公园位于北京市海淀区中部偏东，西北去西直门二十华里。其东南角为清华大学西门。圆明园遗址公园为著名的爱国主义教育基地。圆明园遗址公园建成于1988年，仅存山形水系、园林格局和建筑基址，假山叠石、雕刻残迹仍然可见。在“西洋楼”旧址建有园史展览馆，供人瞻仰凭吊。');
